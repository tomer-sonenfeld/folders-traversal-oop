...
def test_search_by_content_existing_folder(word,files_scanner):
    test_folder_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "testing_folder")
    files_found = files_scanner.search_by_content(test_folder_path,word)
    expected_files = {os.path.join(test_folder_path, "testing_file_include_word"),
                      os.path.join(test_folder_path,"testing_sub_folder","testing_file_include_word")
                     }
...
def test_search_by_content_file_instead_of_folder(word,files_scanner):
    test_folder_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "testing_folder", "testing_file_include_word")
